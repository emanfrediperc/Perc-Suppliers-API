...
async function seed() {
  ...
  console.log('\n=== SEED PASSWORD (for all 6 users): ' + seedPassword + ' ===\n');
  ...
  console.log('  - 6 users (admin/tesoreria/operador/consulta/aprobador/contabilidad@perc.com / admin123)');
